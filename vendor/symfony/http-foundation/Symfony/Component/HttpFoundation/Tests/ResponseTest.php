...
class ResponseTest extends ResponseTestCase
{
	...
	public function testGetDate()
	{
		...
		$this->assertEquals(0, $oneHourAgo->diff($response->getDate())
			->format('%s'), '->getDate() returns the Date header if present');
		
		$response = new Response();
		$date = $response->getDate();
		$this->assertLessThan(1, $date->diff(new \DateTime(), true)
		...
		$this->assertLessThanOrEqual(1, $now->diff($response->getDate())
