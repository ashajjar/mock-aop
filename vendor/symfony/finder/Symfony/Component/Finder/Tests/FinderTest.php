...
class FinderTest extends Iterator\RealIteratorTestCase
{
	...
	{
		$this->assertInstanceOf('Symfony\\Component\\Finder\\Finder', $this->buildFinder($adapter)
			->append(array()));
	}
	...
	{
		$finder = Finder::create()->removeAdapters()
	...
	public function testAdaptersChaining()
	{
		...
		$this->assertIterator($filenames, $finder->in(sys_get_temp_dir())
			->getIterator());
	}
