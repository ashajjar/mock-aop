...
class HistoryTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testCurrent()
	{
		...
		$this->assertSame('http://www.example.com/', $history->current()
