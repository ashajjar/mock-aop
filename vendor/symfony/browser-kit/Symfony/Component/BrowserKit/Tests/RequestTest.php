...
class RequestTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testGetParameters()
	{
		...
		$this->assertEquals(array(
			'foo' => 'bar'
		), $request->getParameters(), '->getParameters() returns the parameters of the request');
	}
	...
	public function testGetFiles()
	{
		...
		$this->assertEquals(array(
			'foo' => 'bar'
		), $request->getFiles(), '->getFiles() returns the uploaded files of the request');
	}
	...
	public function testGetCookies()
	{
		...
		$this->assertEquals(array(
			'foo' => 'bar'
		), $request->getCookies(), '->getCookies() returns the cookies of the request');
	}
	...
	public function testGetServer()
	{
		...
		$this->assertEquals(array(
			'foo' => 'bar'
		), $request->getServer(), '->getServer() returns the server parameters of the request');
	}
}
