...
abstract class AbstractProfilerStorageTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testStore()
	{
		...
		$this->assertCount(10, $this->getStorage()
	...
	public function testStoreSpecialCharsInUrl()
	{
		...
		$profile->setUrl('http://foo.bar/\'');
		$this->getStorage()->write($profile);
		$this->assertTrue(false !== $this->getStorage()
	...
	public function testStoreDuplicateToken()
	{
		...
		$this->assertTrue($this->getStorage()
		...
		$this->assertEquals('http://example.net/', $this->getStorage()
			->read('token')
			->getUrl(), '->write() overwrites the current profile data');
		
		$this->assertCount(1, $this->getStorage()
	...
	public function testRetrieveByIp()
	{
		...
		$this->assertCount(0, $this->getStorage()
	...
	public function testRetrieveByEmptyUrlAndIp()
	{
		...
		$this->assertCount(5, $this->getStorage()
	...
	public function testPurge()
	{
		...
		$this->assertTrue(false !== $this->getStorage()
			->read('token2'));
		$this->assertCount(2, $this->getStorage()
			->find('127.0.0.1', '', 10, 'GET'));
		
		$this->getStorage()->purge();
		
		$this->assertEmpty($this->getStorage()
	...
	public function testDuplicates()
	{
		...
		$this->assertCount(3, $this->getStorage()
