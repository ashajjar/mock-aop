...
class WebdisConnectionTest extends PredisTestCase
{
	...
	{
		$connection = new WebdisConnection($this->getParameters());
		$connection->writeCommand($this->getProfile()
			->createCommand('ping'));
	}
	...
	{
		$connection = new WebdisConnection($this->getParameters());
		$connection->readResponse($this->getProfile()
			->createCommand('ping'));
	}
	...
	{
		$connection = new WebdisConnection($this->getParameters());
		$connection->pushInitCommand($this->getProfile()
			->createCommand('ping'));
	}
	...
	{
		$connection = new WebdisConnection($this->getParameters());
		$connection->executeCommand($this->getProfile()
