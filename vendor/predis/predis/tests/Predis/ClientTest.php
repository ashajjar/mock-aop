...
class ClientTest extends PredisTestCase
{
	...
	public function testConstructorWithNullAndArrayArgument()
	{
		...
		$this->assertSame('prefix:', $profile->getProcessor()
			->getPrefix());
	...
	public function testConstructorWithArrayAndOptionReplicationArgument()
	{
		...
		$this->assertSame('host1', $connection->getConnectionById('master')
			->getParameters()->host);
		$this->assertSame('host2', $connection->getConnectionById('slave')
			->getParameters()->host);
	}
