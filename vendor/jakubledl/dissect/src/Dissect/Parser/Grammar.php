...
class Grammar
{
	 ...
	 *
	 * @param
	 *        	string... The components of the rule.
	 *        	
	...
	public function is()
	{
		...
		$this->rules[$num] = $this->currentRule = $this->groupedRules[$this->currentNonterminal][] = $rule;
	 ...
	 *
	 * @param
	 *        	string The name of the start rule.
	 */
	public function start($name)
	{
		$this->rules[0] = new Rule(0, self::START_RULE_NAME, array(
			$name
		));
	}

	/**
	 * Returns the augmented start rule.
