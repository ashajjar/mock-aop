...
class AutomatonDumperTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertStringEqualsFile(__DIR__ . '/res/graphviz/automaton.dot', $this->dumper->dump());
	}
	...
	{
		$this->assertStringEqualsFile(__DIR__ . '/res/graphviz/state.dot', $this->dumper->dumpState(2));
	}
}
