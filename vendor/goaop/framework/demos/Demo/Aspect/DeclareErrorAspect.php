...
class DeclareErrorAspect implements Aspect
{
	 ...
	 *
	 * @var string @DeclareError("@execution(Demo\Annotation\Deprecated)", level=16384) // E_USER_DEPRECATED
	 */
	 ...
	 *
	 * @var string @DeclareError("execution(public Demo\Example\ErrorDemo->notSoGoodMethod(*))", level=512) // E_USER_WARNING
	 */
