...
<body>
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"> <span class="glyphicon glyphicon-tasks"></span>
							...
							<ul class="dropdown-menu">
								...
								<li><a href="?showcase=property-interceptor">Intercepting access
										to the properties</a></li>
								<li><a href="?showcase=function-interceptor">Intercepting system
										functions</a></li>
								<li><a href="?showcase=dynamic-interceptor">Intercepting magic
										methods (__call and __callStatic)</a></li>
								...
								<li><a href="?showcase=dynamic-traits">Dynamic traits and
										interfaces</a></li>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"> AOP Solutions <b class="caret"></b>
						</a>
							<ul class="dropdown-menu">
								<li><a href="https://github.com/lisachenko/php-deal"
									target="_blank">PhpDeal - Design By Contract Framework</a></li>
								<li><a href="https://github.com/Codeception/AspectMock"
									target="_blank">AspectMock - Testing framework</a></li>
								<li><a href="https://github.com/lisachenko/warlock"
									target="_blank">Warlock - Go! AOP + Symfony DiC</a></li>
							</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"> Videos & Presentations<b class="caret"></b>
						</a>
							<ul class="dropdown-menu">
								<li><a
									href="https://www.youtube.com/watch?feature=player_detailpage&v=aZ_9PuHemBk#t=1283"
									target="_blank">Advanced logging in PHP</a></li>
								<li><a href="https://www.youtube.com/watch?v=BXKQ99-78bI"
									target="_blank">Aspect Oriented Programming in PHP</a></li>
								<li><a
									href="http://tutsplus.s3.amazonaws.com/tutspremium/Quick-Tips/AspectMock-Is-Pretty-Neat.mp4"
									target="_blank">AspectMock Is Pretty Neat</a></li>
								<li class="divider">Slides</li>
								<li><a
									href="http://www.slideshare.net/lisachenko/weaving-aspects-in-php-with-the-help-of-go-aop-library"
									target="_blank">Weaving aspects in PHP with the help of Go! AOP
										library</a></li>
								<li><a
									href="http://www.slideshare.net/lisachenko/aspect-oriented-programming-in-php"
									target="_blank">Aspect-Oriented Programming in PHP (Russian)</a></li>
							</ul></li>
					</ul>
					<ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                        <button type="button"
									class="btn btn-danger active" id="aop_on">Off</button>
                        <?php endif; ?>
                    </div>
						</li>
						<li><a href="https://github.com/lisachenko/go-aop-php"
							target="_blank">Fork me</a></li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
			</div>
	...
	<div class="container">
		...
		<div class="well">
			<!--Here will be an output of code execution-->
			<p>
...
switch ($showCase) {
	...
	case 'function-interceptor':
		...
		$example->testArrayFunctions(array(
			'test' => 1,
			'code' => 2,
			'more' => 1
		));
...
if ($aspectName) :
    ...
    <div class="panel panel-default" id="aspect">
				<div class="panel-heading">
					<a data-toggle="collapse" href="#collapseOne"> Source code of
						aspect </a>
				</div>
				<div class="panel-body well panel-collapse collapse out"
					id="collapseOne">
<?php
...
if ($example) :
    ...
    <div class="panel panel-default">
				<div class="panel-heading">
					<a data-toggle="collapse" href="#collapseTwo"> Source code of class
					</a>
				</div>
				<div class="panel-body well panel-collapse collapse out"
					id="collapseTwo">
