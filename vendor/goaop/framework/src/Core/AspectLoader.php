...
class AspectLoader
{
	 ...
	 *        	Instance of container to store pointcuts and advisors
	 * @param Reader $reader
	 *        	Reader for annotations that is used for aspects
	 */
	 ...
	 *
	 * @param AspectLoaderExtension $loader
	 *        	Loader to register
	 */
	 ...
	 * @param Aspect $aspect
	 *        	Aspect instance
	 * @param \ReflectionClass|\ReflectionMethod|\ReflectionProperty $refPoint
	 *        	Reflection instance
	 * @param array|AspectLoaderExtension[] $loaders
	 *        	List of loaders that can produce advisors from aspect class
	 *        	
