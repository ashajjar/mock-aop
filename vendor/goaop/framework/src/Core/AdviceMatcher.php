...
class AdviceMatcher
{
	 ...
	 * @param bool $isInterceptFunctions
	 *        	Optional flag to enable function interception
	 */
	 ...
	 * @param array|Aop\Advisor[] $advisors
	 *        	List of advisor to match
	 *        	
	 * @return array
	 */
	 ...
	 *
	 * @param ParsedReflectionClass $class
	 *        	Class to advise
	 * @param array|Aop\Advisor[] $advisors
	 *        	List of advisor to match
	 *        	
	 ...
	 *
	 * @param ParsedReflectionClass $class
	 *        	Class to inject advices
	 * @param Aop\PointcutAdvisor $advisor
	 *        	Advisor for class
	 * @param string $advisorId
	 *        	Identifier of advisor
	 * @param Aop\PointFilter $filter
	 *        	Filter for points
	 *        	
	 * @return array
	 */
	private function getAdvicesFromAdvisor(ParsedReflectionClass $class, Aop\PointcutAdvisor $advisor, $advisorId, Aop\PointFilter $filter)
	{
		$classAdvices = array();
	 ...
	 * @param ParsedReflectionClass $class
	 *        	Class to inject advices
	 * @param Aop\IntroductionAdvisor $advisor
	 *        	Advisor for class
	 * @param string $advisorId
	 *        	Identifier of advisor
	 *        	
	 * @return array
	 */
	private function getIntroductionFromAdvisor(ParsedReflectionClass $class, Aop\IntroductionAdvisor $advisor, $advisorId)
	{
	 ...
	 * @param string $advisorId
	 *        	Identifier of advisor
	 * @param Aop\PointFilter $pointcut
	 *        	Filter for points
	 *        	
	 * @return array
	 */
