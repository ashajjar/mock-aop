...
class IntroductionAspectExtension extends AbstractAspectLoaderExtension
{
	 ...
	 * @param Aspect $aspect
	 *        	Instance of aspect
	 * @param mixed|\ReflectionClass|\ReflectionMethod|\ReflectionProperty $reflection
	 *        	Reflection of point
	 * @param mixed|null $metaInformation
	 *        	Additional meta-information, e.g. annotation for method
	 *        	
	...
	{
		return ($metaInformation instanceof Annotation\DeclareParents) || ($metaInformation instanceof Annotation\DeclareError);
	}
