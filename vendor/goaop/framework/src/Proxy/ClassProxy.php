...
class ClassProxy extends AbstractProxy
{
	 ...
	 *
	 * @param ParsedClass $parent
	 *        	Parent class reflection
	 * @param array|Advice[] $classAdvices
	 *        	List of advices for class
	 * @param bool $useStaticForLsb
	 *        	Should proxy use 'static::class' instead of '\get_called_class()'
	 *        	
	 ...
	 *        	See ReflectionMethod modifiers
	 * @param string $methodName
	 *        	Name of the method
	 * @param string $body
	 *        	Body of method
...
"}\n"); // End of method body
	 ...
	 *        	Aop child proxy class
	 * @param array|Advice[] $advices
	 *        	List of advices to inject into class
	 *        	
	 * @return void
	 */
	 ...
	 *
	 * @param bool $useClosureBinding
	 *        	Enables usage of closures instead of reflection
	 * @param bool $useSplatOperator
	 *        	Enables usage of optimized invocation with splat operator
	 */
	 ...
	 *
	 * @param array|Advice[] $classAdvices
	 *        	Advices for specific class
	 * @param string $className
	 *        	Name of the original class to use
	 *        	
	 ...
	 *
	 * @param int $propFlags
	 *        	See ReflectionProperty modifiers
...
";\n"); // End of line with property definition
	...
	{
		$this->setProperty(Property::IS_PRIVATE | Property::IS_STATIC, '__joinPoints', 'array()');
	}
	 ...
	 *        	Reflection of property to intercept
	 */
...
"}"); // End of class definition
		...
		PHP_EOL . '\\' . __CLASS__ . "::injectJoinPoints('" . $this->class->name . "'," . var_export($this->advices, true) . ");";
	}

	/**
	 * Add code for intercepting properties
	 *
	 * @param null|ParsedMethod $constructor
	 *        	Constructor reflection or null
	 */
...
SETTER;
	 ...
	 *
	 * @param ParsedMethod $constructor
	 *        	Constructor reflection
	 * @param bool $isCallParent
	 *        	Is there is a need to call parent code
	 *        	
	 * @return string
	 */
