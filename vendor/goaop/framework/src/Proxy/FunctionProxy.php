...
class FunctionProxy extends AbstractProxy
{
	 ...
	 *
	 * @param string $joinPointName
	 *        	Special joinpoint name
...
join("\n", $this->functionsCode)); // Function definitions
		...
		PHP_EOL . '\\' . __CLASS__ . "::injectJoinPoints('" . $this->namespace->getName() . "'," . var_export($this->advices, true) . ");";
	}
