...
class PointcutBuilder
{
	...
	{
		$this->container->registerAdvisor(new LazyPointcutAdvisor($this->container, $pointcutExpression, new BeforeInterceptor($advice)), $this->getPointcutId($pointcutExpression));
	}
	...
	{
		$this->container->registerAdvisor(new LazyPointcutAdvisor($this->container, $pointcutExpression, new AfterInterceptor($advice)), $this->getPointcutId($pointcutExpression));
	}
	...
	{
		$this->container->registerAdvisor(new LazyPointcutAdvisor($this->container, $pointcutExpression, new AfterThrowingInterceptor($advice)), $this->getPointcutId($pointcutExpression));
	}
	...
	{
		$this->container->registerAdvisor(new LazyPointcutAdvisor($this->container, $pointcutExpression, new AroundInterceptor($advice)), $this->getPointcutId($pointcutExpression));
	}
