...
class OrPointcut extends AndPointcut
{
	 ...
	 *
	 * @param Pointcut $first
	 *        	First filter
	 * @param Pointcut $second
	 *        	Second filter
	 */
	 ...
	 *
	 * @param mixed $point
	 *        	Specific part of code, can be any Reflection class
	 * @param object|string|null $instance
	 *        	[Optional] Instance for dynamic matching
	 * @param array $arguments
	 *        	[Optional] Extra arguments for dynamic matching
	 *        	
	 * @return bool
	 */
	public function matches($point, $instance = null, array $arguments = null)
	{
		return $this->isMatchesPointcut($point, $this->first, $instance, $arguments) || $this->isMatchesPointcut($point, $this->second, $instance, $arguments);
	}
}
