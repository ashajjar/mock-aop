...
class MagicMethodPointcut implements MethodMatcher, Pointcut
{
	 ...
	 *        	Name of the dynamic method to match or glob pattern
	 * @param PointFilter $modifierFilter
	 *        	Method modifier filter (static or not)
	 */
	 ...
	 * @param null|string|object $instance
	 *        	Invocation instance or string for static calls
	 * @param null|array $arguments
	 *        	Dynamic arguments for method
	 *        	
	 * @return bool
	 */
