...
class ClassMemberReference
{
	 ...
	 * @param ModifierMatcherFilter $visibilityFilter
	 *        	Public/protected/etc
	 * @param ModifierMatcherFilter $accessTypeFilter
	 *        	Static or dynamic
	 * @param string $memberNamePattern
	 *        	Expression for the name
	 */
	public function __construct(PointFilter $classFilter, ModifierMatcherFilter $visibilityFilter, ModifierMatcherFilter $accessTypeFilter, $memberNamePattern)
	{
