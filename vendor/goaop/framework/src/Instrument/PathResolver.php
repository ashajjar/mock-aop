...
class PathResolver
{
	 ...
	 *
	 * @param string|array $somePath
	 *        	Path without normalization or array of paths
	 * @param bool $shouldCheckExistence
	 *        	Flag for checking existence of resolved filename
	 *        	
	...
	public static function realpath($somePath, $shouldCheckExistence = false)
	{
		...
		list ($pathScheme, $path) = isset($components[1]) ? $components : array(
			null,
			$components[0]
		);
