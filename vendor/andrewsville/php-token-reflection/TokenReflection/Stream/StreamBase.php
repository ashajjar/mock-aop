...
abstract class StreamBase implements SeekableIterator, Countable, ArrayAccess, Serializable
{
	 ...
	 *
	 * @param boolean $skipDocBlocks
	 *        	Skip docblocks as well
	 ...
	 *        	Consider docblocks as whitespaces
	 * @return boolean
	 */
	 ...
	 *        	Position; if none given, consider the current iteration position
	 * @return boolean
	 */
	 ...
	 *
	 * @param integer $position
	 *        	Token position; if none given, consider the current iteration position
