...
class Broker
{
	 ...
	 * Constructor.
	 *
	 * @param \TokenReflection\Broker\Backend $backend
	 *        	Broker backend instance
	 * @param integer $options
	 *        	Broker/parsing options
	 */
	public function __construct(Broker\Backend $backend, $options = self::OPTION_DEFAULT)
	{
		...
		$this->backend = $backend->setBroker($this)->setStoringTokenStreams((bool) ($options & self::OPTION_SAVE_TOKEN_STREAM));
	}
	 ...
	 *        	Used file name
	 * @param boolean $returnReflectionFile
	 *        	Returns the appropriate \TokenReflection\ReflectionFile instance(s)
	 ...
	 *
	 * @param integer $types
	 *        	Returned class types (multiple values may be OR-ed)
	 * @return array
	 */
