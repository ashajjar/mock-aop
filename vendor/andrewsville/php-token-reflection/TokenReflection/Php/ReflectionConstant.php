...
class ReflectionConstant implements IReflection, TokenReflection\IReflectionConstant
{
	 ...
	 *        	Reflection broker
	 * @param \TokenReflection\Php\ReflectionClass $parent
	 *        	Defining class reflection
	...
	{
		return sprintf("Constant [ %s %s ] { %s }\n", gettype($this->getValue()), $this->getName(), $this->getValue());
	}
	 ...
	 *        	Class name, class instance or null
	 ...
	 *
	 * @param \ReflectionClass $internalReflection
	 *        	Internal reflection instance
	 * @param \TokenReflection\Broker $broker
