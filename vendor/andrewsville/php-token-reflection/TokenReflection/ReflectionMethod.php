...
class ReflectionMethod extends ReflectionFunctionBase implements IReflectionMethod
{
	 ...
	 *
	 * @see http://svn.php.net/viewvc/php/php-src/branches/PHP_5_3/Zend/zend_compile.h?revision=306939&view=markup#l114 ZEND_ACC_IMPLICIT_PUBLIC
	 *     
	 * @var integer
	 */
	 ...
	 *
	 * @see http://svn.php.net/viewvc/php/php-src/branches/PHP_5_3/Zend/zend_compile.h?revision=306939&view=markup#l134 ZEND_ACC_CHANGED
	 *     
	 * @var integer
	 */
	 ...
	 *
	 * @see http://svn.php.net/viewvc/php/php-src/branches/PHP_5_3/Zend/zend_compile.h?revision=306939&view=markup#l138 ZEND_ACC_CTOR
	 *     
	 * @var integer
	 */
	 ...
	 *
	 * @see http://svn.php.net/viewvc/php/php-src/branches/PHP_5_3/Zend/zend_compile.h?revision=306939&view=markup#l139 ZEND_ACC_DTOR
	 *     
	 * @var integer
	 */
	 ...
	 * Method is __clone().
	 *
	 * @see http://svn.php.net/viewvc/php/php-src/branches/PHP_5_3/Zend/zend_compile.h?revision=306939&view=markup#l140 ZEND_ACC_CLONE
	 *     
	 * @var integer
	 */
	 ...
	 *
	 * @see http://svn.php.net/viewvc/php/php-src/branches/PHP_5_3/Zend/zend_compile.h?revision=306939&view=markup#l143 ZEND_ACC_ALLOW_STATIC
	 *     
	 * @var integer
	 */
	...
	/**
	 * Shortcut for isPublic(), .
	 *
	 * .. methods that allows or-ed modifiers.
	 *
	...
	public function __toString()
	{
		...
		if ($this->getNumberOfParameters() > 0) {
			...
			$parameters = sprintf("\n\n  - Parameters [%d] {%s\n  }", $this->getNumberOfParameters(), $buffer);
		}
		// @todo support inherits
		return sprintf("%sMethod [ <%s%s%s%s> %s%s%s%s%s%s method %s%s ] {\n  @@ %s %d - %d%s\n}\n", $this->getDocComment() ? $this->getDocComment() . "\n" : '', ! empty($internal) ? $internal : 'user', $overwrite, $prototype, $cdtor, $this->isAbstract() ? 'abstract ' : '', $this->isFinal() ? 'final ' : '', $this->isStatic() ? 'static ' : '', $this->isPublic() ? 'public' : '', $this->isPrivate() ? 'private' : '', $this->isProtected() ? 'protected' : '', $this->returnsReference() ? '&' : '', $this->getName(), $this->getFileName(), $this->getStartLine(), $this->getEndLine(), $parameters);
	}

	/**
	 * Exports a reflected object.
	 *
	 * @param \TokenReflection\Broker $broker
	 *        	Broker instance
	 ...
	 *        	Return the export instead of outputting it
	 * @return string|null
	 ...
	 *
	 * @param \TokenReflection\ReflectionClass $parent
	 *        	New parent class
	 * @param string $name
	 *        	New method name
	...
	{
		static $possibleLevels = array(
			InternalReflectionMethod::IS_PUBLIC => true,
			InternalReflectionMethod::IS_PROTECTED => true,
			InternalReflectionMethod::IS_PRIVATE => true
		);
	 ...
	 *
	 * @param \TokenReflection\IReflection $parent
	 *        	Parent reflection object
	 * @param \TokenReflection\Stream\StreamBase $tokenStream
	 *        	Token substream
	 ...
	 * ..).
	 *
	 * @param \TokenReflection\ReflectionClass $class
	 *        	Parent class
	 * @return \TokenReflection\ReflectionMethod
	 */
