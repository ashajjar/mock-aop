...
final class FileProcessingException extends RuntimeException
{
	 ...
	 * @param array $reasons
	 *        	Resons why the file could not be processed
	 * @param \TokenReflection\ReflectionFile $sender
	 *        	Reflection file
	 */
	public function __construct(array $reasons, ReflectionFile $sender = null)
	{
		parent::__construct(null === $sender ? 'There was an error processing the file.' : sprintf('There was an error processing the file %s.', $sender->getName()), 0, $sender);
