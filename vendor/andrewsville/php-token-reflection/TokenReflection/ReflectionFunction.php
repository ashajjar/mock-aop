...
class ReflectionFunction extends ReflectionFunctionBase implements IReflectionFunction
{
	...
	public function __toString()
	{
		...
		return sprintf("%sFunction [ <user> function %s%s ] {\n  @@ %s %d - %d%s\n}\n", $this->getDocComment() ? $this->getDocComment() . "\n" : '', $this->returnsReference() ? '&' : '', $this->getName(), $this->getFileName(), $this->getStartLine(), $this->getEndLine(), $parameters);
	}
	...
	{
		return $this->parseReturnsReference($tokenStream)->parseName($tokenStream);
	}
}
