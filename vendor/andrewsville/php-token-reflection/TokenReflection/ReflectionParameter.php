...
class ReflectionParameter extends ReflectionElement implements IReflectionParameter
{
	...
	public function __toString()
	{
		...
		return sprintf('Parameter #%d [ <%s> %s%s$%s%s ]', $this->getPosition(), $this->isOptional() ? 'optional' : 'required', $hint ? $hint . ' ' : '', $this->isPassedByReference() ? '&' : '', $this->getName(), $default);
	}
	 ...
	 *
	 * @param \TokenReflection\ReflectionMethod $parent
	 *        	New parent method
