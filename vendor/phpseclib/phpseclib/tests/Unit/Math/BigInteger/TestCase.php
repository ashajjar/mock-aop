...
abstract class Unit_Math_BigInteger_TestCase extends PhpseclibTestCase
{
	...
	{
		$this->assertSame(chr(65), $this->getInstance('65')
			->toBytes());
	}

	public function testToBytesTwosCompliment()
	{
		$this->assertSame(chr(126), $this->getInstance('01111110', 2)
			->toBytes(true));
	}

	public function testToHex()
	{
		$this->assertSame('41', $this->getInstance('65')
			->toHex());
	}

	public function testToBits()
	{
		$this->assertSame('1000001', $this->getInstance('65')
			->toBits());
	}
	...
	public function testBitwiseAND()
	{
		...
		$this->assertSame($z->toHex(), $x->bitwise_AND($y)
			->toHex());
	}
	...
	public function testBitwiseOR()
	{
		...
		$this->assertSame($z->toHex(), $x->bitwise_OR($y)
			->toHex());
	}
	...
	public function testBitwiseXOR()
	{
		...
		$this->assertSame($z->toHex(), $x->bitwise_XOR($y)
			->toHex());
	}
	...
	public function testBitwiseNOT()
	{
		...
		$this->assertSame($z->toHex(), $x->bitwise_NOT()
			->toHex());
	}
	...
	public function testBitwiseLeftShift()
	{
		...
		$this->assertSame($y->toHex(), $x->bitwise_LeftShift(16)
			->toHex());
	}
	...
	public function testBitwiseRightShift()
	{
		...
		$this->assertSame($y->toHex(), $x->bitwise_RightShift(16)
			->toHex());
		$this->assertSame($z->toHex(), $x->bitwise_RightShift(32)
			->toHex());
		$this->assertSame($n->toHex(), $x->bitwise_RightShift(36)
			->toHex());
	}
